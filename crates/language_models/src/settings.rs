...
use crate::provider::{
    ...
    vercel::VercelSettings, vertex::VertexSettings, x_ai::XAiSettings,
};
...
impl settings::Settings for AllLanguageModelSettings {
    ...
    fn from_settings(content: &settings::SettingsContent) -> Self {
        ...
        let vertex = language_models.vertex.unwrap();
        ...
        Self {
            ...
            vertex: VertexSettings {
                ...
                credentials_command: vertex.credentials_command,
                credentials_refresh_interval: vertex.credentials_refresh_interval,
